...
class WearablesViewModel: ObservableObject {
  ...
  init(wearables: WearablesInterface) {
    ...
    if let savedLanguage = UserDefaults.standard.string(forKey: "appLanguage"),
      ...
      // Convert system to actual default language
      if language == .system {
        self.selectedLanguage = AppLanguage.defaultLanguage
        // Save the actual language instead of system
        UserDefaults.standard.set(self.selectedLanguage.rawValue, forKey: "appLanguage")
      } else {
